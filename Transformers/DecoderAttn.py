...
class DecoderAttn(tf.keras.layers.Layer):
	...
	def call(self, x, enc_output, training, look_ahead_mask, padding_mask):
		...
		x = self.layernorm1(x)
		attn1, attn_weights_block1 = self.mha1(x, x, x, look_ahead_mask, look_ahead = True)  # (batch_size, target_seq_len, d_model)
		...
		#pdb.set_trace()
		padding_mask = create_padding_mask(enc_output)
		attn2, attn_weights_block2 = self.mha2(enc_output, enc_output, out3, padding_mask, look_ahead = False)  # (batch_size, target_seq_len, d_model)
